...
(function() {
  $(function() {
    var channel_dispatcher, room_name, user_name, ws_dispatcher;
    console.log(window.rails_env);
    $('#user_list_box').css('background-color', '#cfc');
    user_name = $('#user_name').text();
    room_name = $('#room_name').text();
    ws_dispatcher = void 0;
    channel_dispatcher = void 0;
    ...
    channel_dispatcher.bind('cast_new_message', function(message) {
      var create_message_li, message_li;
    ...
    ws_dispatcher.bind('bload_cast_change_user_list', function(dummy_hash) {
      ws_dispatcher.trigger('get_user_list', {
        room_name: room_name
      });
    });
...
(function() {
  $(function() {
    ...
    $('.enter_poker_room_button').click(function() {
      console.log('room' + this.id + ' clicked ' + $('#user_name').val());
      window.location.href = 'poker_rooms/' + this.id + '?user_name=' + $('#user_name').val();
    });
  });
...
(function() {
  $(function() {
    ...
    $('.enter_button').click(function() {
      console.log('room' + this.id + ' clicked ' + $('#user_name').val());
      window.location.href = 'rooms/' + this.id + '?user_name=' + $('#user_name').val();
    });
  });
...
(function() {
  $(document).on("ready page:load", function() {
    ...
    return $("dl dt").on("click", function() {
...
$(document).ready(function(){
	//$('table#jtable td').css('text-align', 'left').css('width', 90);
	$('table#jtable tr').css('background-color', '#999');
});
//$(function(){
//	$("dd:not(:first)").css("display","none");
